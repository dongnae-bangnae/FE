...
export default function LikePlacePage() {
  ...
  return (
    <>
      <Header title="회원정보" underline={false} />

      <div className="w-full max-w-[390px] mx-auto min-h-screen bg-white flex flex-col relative mt-20">
        {step === "intro" ? (
          /* ===================== [피그마 0.2.3-1 초기 화면] ===================== */
          <>
            {/* 헤더 (필요 시 아이콘 추가) */}
            ...
            <div className="px-6">
              <h1 className="text-[20px] font-semibold mt-2 text-center">
                좋아하는 동네를 알려주세요!
              </h1>

...
export default function PinInfoModal() {
    ...
    const [placeName, setPlaceName] = useState<string>("해옫 연남");
    const [pinCategory, setPinCategory] = useState<string>("맛집"); 
	return (
		<div className="absolute bottom-0 left-0 w-full z-10 bg-white rounded-t-xl shadow-lg p-4">
            ...
            <div className="flex justify-between items-center">
				...
				<button className="text-gray-500 text-2xl mb-5">×</button>
			</div>
